  ...
  _createClass(DataSeries, [{
    ...
    value: function render() {
      ...
      var bars = this.props.data.map(function (point, i) {
        return _react2.default.createElement(_Bar2.default, { height: yScale(point.value), width: xScale.rangeBand(), offset: xScale(i), availableHeight: props.height, color: props.color, key: i });
      });
